...
public class ReportAction implements EventListener<Event>
{
	...
	public void show() 
	{
		...
		LayoutUtils.openPopupWindow(panel.getToolbar().getButton("CustomReportBtn"), winReport, "after_start");
	}
	...
	private void getPrintFormats(int AD_Table_ID, int AD_Window_ID)
	{
		...
		int index=panel.getActiveGridTab().getCurrentRow();
		panel.getActiveGridTab().getValue(0, "C_DocTypeTarget_ID");  
